# 1 "c:\\globe\\12_local\\vueling\\fase_2\\estructura git\\performance\\ci\\vueling\\scripts\\01_buscarvuelo_ticketsqafront01\\\\combined_01_BuscarVuelo_Ticketsqafront01.c"
...
# 1 "c:\\globe\\12_local\\vueling\\fase_2\\estructura git\\performance\\ci\\vueling\\scripts\\01_buscarvuelo_ticketsqafront01\\\\combined_01_BuscarVuelo_Ticketsqafront01.c" 2
...
# 2 "c:\\globe\\12_local\\vueling\\fase_2\\estructura git\\performance\\ci\\vueling\\scripts\\01_buscarvuelo_ticketsqafront01\\\\combined_01_BuscarVuelo_Ticketsqafront01.c" 2
...
# 3 "c:\\globe\\12_local\\vueling\\fase_2\\estructura git\\performance\\ci\\vueling\\scripts\\01_buscarvuelo_ticketsqafront01\\\\combined_01_BuscarVuelo_Ticketsqafront01.c" 2
...
# 4 "c:\\globe\\12_local\\vueling\\fase_2\\estructura git\\performance\\ci\\vueling\\scripts\\01_buscarvuelo_ticketsqafront01\\\\combined_01_BuscarVuelo_Ticketsqafront01.c" 2
...
Action()
{
	...
	lr_save_datetime("%Y-%m-%d", 0 + 86400 * atoi(lr_eval_string("{p_DaysFuture}")), "p_FechaIda");
	lr_save_datetime("%Y-%m", 0 + 86400 * atoi(lr_eval_string("{p_DaysFuture}")), "p_AnoMesIda");
	lr_save_datetime("%d", 0 + 86400 * atoi(lr_eval_string("{p_DaysFuture}")), "p_DiaIda");

	 
	lr_save_datetime("%Y-%m-%d", 0 + 86400 * (atoi(lr_eval_string("{p_DaysFuture}")) + atoi(lr_eval_string("{p_OffsetVuelta}"))), "p_FechaVuelta");
	lr_save_datetime("%Y-%m", 0 + 86400 * (atoi(lr_eval_string("{p_DaysFuture}")) + atoi(lr_eval_string("{p_OffsetVuelta}"))), "p_AnoMesVuelta");
	lr_save_datetime("%d", 0 + 86400 * (atoi(lr_eval_string("{p_DaysFuture}")) + atoi(lr_eval_string("{p_OffsetVuelta}"))), "p_DiaVuelta");
	...
	lr_end_transaction("01_01_CargarURL_Ticketsqafront01",2);
	...
	lr_end_transaction("01_02_BuscarVuelo_Ticketsqafront01",2);
	
	lr_end_transaction("01_99_BuscarVuelo_Ticketsqafront01",2);

	return 0;
	
}
# 5 "c:\\globe\\12_local\\vueling\\fase_2\\estructura git\\performance\\ci\\vueling\\scripts\\01_buscarvuelo_ticketsqafront01\\\\combined_01_BuscarVuelo_Ticketsqafront01.c" 2
...
# 6 "c:\\globe\\12_local\\vueling\\fase_2\\estructura git\\performance\\ci\\vueling\\scripts\\01_buscarvuelo_ticketsqafront01\\\\combined_01_BuscarVuelo_Ticketsqafront01.c" 2
